...
<div id="reply${reply._id}" class="reply">
  ...
  <div class="replyMsgMt">${reply.msgMt}</div>
...
/*
V.smsRender = function (posts, user) {
  return V.render.smsView({posts: posts, user: user})
}
*/